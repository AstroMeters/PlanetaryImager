...
define_setting(solar_hough_param1, int, 100)
define_setting(solar_hough_param2, int, 50)
define_setting(solar_radius_min, int, 50)
define_setting(solar_radius_max, int, 500)
